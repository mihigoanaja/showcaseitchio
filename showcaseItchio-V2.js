...
directFetch("https://apiproxy.alreflections.net/corsload/"+btoa("https://itch.io/api/1/atij2d75QwTDXTu6bGSDASiHyPbjswJkCROiSWcH/my-games")).then(gamesData=>JSON.parse(gamesData).games.forEach(game => {
  var gameHTML = `
    <div class='game'>
